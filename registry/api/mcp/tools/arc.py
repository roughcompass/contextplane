...
`registry.api.schemas.arc_authoring` defines, rebuilding them from the same
...
from registry.arc.service.activation import ActivationEligibility, ActivationService
...
from registry.arc.service.proposal import ProposalService, ProposalVersion
from registry.arc.service.qualification import ObservationStatus, QualificationService
