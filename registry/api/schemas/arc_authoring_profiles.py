...
`registry.arc.schemas.authoring_profile_shapes`, and
...
from registry.api.schemas.arc_authoring_enums import DeltaCode, OwningScope
from registry.api.schemas.arc_authoring_shared import Digest, _ClosedModel
