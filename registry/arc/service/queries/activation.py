...
from registry.arc.service.queries.proposal import _VERSION_COLUMNS, VersionRow, _version_row
from registry.arc.service.queries.qualification import _QUAL_COLS, QualificationRow, _qualification_row
