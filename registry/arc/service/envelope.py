...
`arc_proposal_validation_failed`.** `registry.arc.schemas.authoring_
...
from registry.arc.schemas.authoring_profile_shapes import EXPECTED_IMPACT_ENVELOPE_PROFILE
