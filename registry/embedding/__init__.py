...
def build_embedder(settings: Settings) -> Embedder:
    ...
    if provider == "stub":
        from registry.embedding.stub import StubEmbedder  # noqa: PLC0415

        return StubEmbedder(dim=settings.embedding_dim)

    if provider == "onnx":
        from registry.embedding.local_onnx import OnnxEmbedder  # noqa: PLC0415
    ...
    if provider == "sentence_transformers":
        from registry.embedding.local_torch import SentenceTransformerEmbedder  # noqa: PLC0415
    ...
    if provider == "http":
        from registry.embedding.remote_http import HttpEmbedder  # noqa: PLC0415
