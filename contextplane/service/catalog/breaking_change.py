...
1. :mod:`contextplane.service.catalog.interface_normalize` — turn the producer's
   proposed interface declaration into a canonical
   :class:`~contextplane.types.InterfaceSurface`.
2. Semver validation — reject malformed proposed versions early.
3. :mod:`contextplane.service.catalog.interface_diff` — classify the change and emit
