...
defined below — the other is `contextplane/arc/models.py`, which mirrors the ARC
...
class Actor(Base, TenantMixin):
    ...
    # (contextplane/ingest/runner.py uses actor_kind to distinguish humans from workers).
