...
from contextplane.usage.identity import read_mcp_identity, read_request_identity
from contextplane.usage.results import read_mcp_result_count, read_result_count
from contextplane.usage.vocabularies import (
    OUTCOME_ERROR,
    OUTCOME_OK,
    SURFACE_MCP,
    SURFACE_REST,
...
def _writer(app: object) -> UsageWriter | None:
    ...
    see ``contextplane.api.mcp.context._services``) from the MCP path — two
