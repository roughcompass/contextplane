...
from contextplane.arc.service.queries import materialisation as materialisation_queries
...
class CandidateGovernanceRowRejected(RegistryError):
    ...
    destination (`contextplane.arc.types.parse_wire_directive_type`), so this
...
class ArtifactMaterialisationService:
    ...
    def _directive_row(
        ...
        `directive_type` is *translated*, through `contextplane.arc.types.
