...
from contextplane.arc.service.authorization import ArcAuthorizationError, ArcAuthorizationService, ArtifactScope
from contextplane.arc.service.queries import proposal as queries
...
# `contextplane/api/schemas/arc_authoring.py`'s own docstring) because ADR 040's
