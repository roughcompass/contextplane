...
below calls `contextplane.arc.schemas.authoring_profiles.
...
from contextplane.arc.schemas.authoring_profile_shapes import ACTOR_SEPARATION_PROFILE, ARTIFACT_REVISION_PROFILE
