...
#: `contextplane.arc.schemas.parser_output.MAX_ENVELOPE_BYTES` (1 MiB): that
...
class SandboxRefusalCode(enum.StrEnum):
    ...
    `contextplane.arc.schemas.parser_output.ParserRefusalCode`: that vocabulary
...
def request_json(
    ...
    *,
    ...
    (see `contextplane.arc.schemas.parser_output.verify_source_binding`).
    """
