...
Run via ``python -m contextplane.arc.sandbox.parser_main`` -- one process per
...
``contextplane.wiring``, or ``contextplane.config`` -- it has no database
...
from contextplane.arc.schemas.parser_output import (
    MAX_SECTIONS,
    MAX_TEXT_LENGTH,
