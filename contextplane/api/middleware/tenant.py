...
from contextplane.api.auth.oidc import validate_oidc_token
...
from contextplane.auth.resolver import ResolvedIdentity, TenantGrant
from contextplane.exceptions import CatalogError
from contextplane.types import TenantContext, TenantMembership
from contextplane.usage.identity import UsageIdentity, stash_request_identity
...
def _build_tenant_context(
    *,
    ...
    forward alias) point at the same UUID — see ``contextplane.types``.
    """
    tenant_memberships = [
        TenantMembership(
