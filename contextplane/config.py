...
from contextplane.config_llm_roles import LlmRoleSettings
...
class Settings(LlmRoleSettings, BaseSettings):
    ...
    # LLM provider roles — extraction, simulation, and the judges — live in
    # `config_llm_roles.LlmRoleSettings`, which this model inherits. See that
    # module for why they are one seam rather than three unrelated blocks.
