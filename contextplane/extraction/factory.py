...
from contextplane.extraction.anthropic_provider import DEFAULT_MODEL as ANTHROPIC_DEFAULT_MODEL
from contextplane.extraction.anthropic_provider import build_from_env
...
from contextplane.extraction.openai_provider import build_from_env as build_openai_from_env
from contextplane.extraction.provider import ExtractionProvider, NoOpProvider
...
def build_provider(settings: Settings, *, env: dict[str, str] | None = None) -> ExtractionProvider:
    ...
    `CLAUDE_API_KEY`/`ANTHROPIC_API_KEY` spellings (see `contextplane/config.py`),
