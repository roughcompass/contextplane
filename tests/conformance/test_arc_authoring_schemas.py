...
_EXPECTED_ENUM_VALUES: dict[type[enum.Enum], frozenset[str]] = {
    ...
    aa.AdmissionMethod: frozenset({"connector_fetch", "authorized_upload", "graph_promotion"}),
    aa.VerificationMethod: frozenset({"detached_signature", "verifier_attestation", "graph_promotion"}),
