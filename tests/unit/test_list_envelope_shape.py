...
def test_search_response_uses_items_field() -> None:
    ...
    from contextplane.api.schemas.catalog import SearchResponse, SearchResultItem
...
def test_a_search_result_cannot_be_built_without_its_citations() -> None:
    ...
    from contextplane.api.schemas.catalog import SearchResultItem
...
def _make_ext_id_ref() -> Any:
    from contextplane.types import ExternalIdRef
...
def _build_external_ids_app(*, list_return: list[Any] | None = None) -> FastAPI:
    from contextplane.api.middleware.tenant import get_tenant_context
    from contextplane.api.routers.external_ids import entity_external_ids_router
    from contextplane.types import EntityRef
...
def _build_integrations_app(*, refs: list[Any] | None = None) -> FastAPI:
    from contextplane.api.middleware.tenant import get_tenant_context
    from contextplane.api.routers.integrations import router
...
def test_audit_response_uses_items_not_rows() -> None:
    ...
    from contextplane.api.routers.admin_audit import AuditResponse, AuditRow
