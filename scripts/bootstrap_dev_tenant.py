...
_DEFAULT_CLIENT_SECRET = "dev-secret"  # noqa: S105 - throwaway fixture value for the local mock OIDC provider this script bootstraps against; not a credential for anything real
